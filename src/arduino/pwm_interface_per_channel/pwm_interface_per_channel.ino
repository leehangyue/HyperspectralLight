...
void loop() {
  ...
  if (Serial.available() > 2) {
    ...
    int address = Serial.read();  // Read the address of the I2C device
    ...
    Serial.print("Number of channels: "); Serial.println(numCh);
    ...
    */
    ...
    pwm = Adafruit_PWMServoDriver(address, myWire);
    pwm.begin();
